...
class ConnectedMusicServiceInsightsReadTest {
    @Test
    void readsTheProjectedSnapshotWithoutPollingNotionOnAnInsightsCacheMiss() {
        ...
        given(graph.retrievalMethod()).willReturn("PERSISTENT_GRAPHDB_PERSONAL_EVIDENCE_RETRIEVAL");
        ...
        assertThat(insights.taste().recordCount()).isEqualTo(1);
