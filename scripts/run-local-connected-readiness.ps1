...
foreach ($name in @(
        ...
        "NOTION_RELEASE_GROUP_MBID_FIELD", "NOTION_RELEASE_MBID_FIELD", "NOTION_CATALOG_SOURCE_FIELD", "NOTION_CATALOG_ID_FIELD", "MUSICBRAINZ_USER_AGENT", "MUSIC_KG_GRAPHDB_BASE_URL",
